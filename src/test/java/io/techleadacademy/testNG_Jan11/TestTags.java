...
public class TestTags {
    ...
    @Test(invocationCount = 2, skipFailedInvocations = true)// by default this method is false.
    ...
    @Test
    public void testUserName1(@Optional("XX") String username, @Optional("55") String password){// in case we dont have parameters
        Reporter.log("Testing Logs in functionality using valid credentials");
        String actual = "AAA";
